function [] = heat_equation_1D_cn_scheme_example_1
...
for j = 1:Nt
    ...
    %%% 
    w_old = w0;
    w_r = evolution_mat_r(2:N,2:N)*w_old;
    w_new = evolution_mat_l(2:N,2:N)\w_r; % CN scheme: solves linear algebra problem (I-lambda*A)*w^(n+1) = (I+lambda*A)*w^(n) at each time step
    w0 = w_new;
%     
end
%t;
